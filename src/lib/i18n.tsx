...
export const translations = {
  en: {
    ...
    contact: {
      ...
      hqAddress: "124 Print Ave, Creative District\nNew York, NY 10012",
    },
    portfolioPage: {
      hero: "Our",
      heroHighlight: "Work",
  ...
  ar: {
    ...
    why: {
      heading: "لماذا\nنختلف",
      items: [
        { num: "٠١", title: "جودة استثنائية", desc: "نستخدم أحدث الطابعات والفينيل الفاخر. ملصقاتك لن تبهت أو تُخدش أو تنقشر بسهولة." },
        { num: "٠٢", title: "سرعة البرق", desc: "الأفكار لا تنتظر. نقدم أوقات إنجاز سريعة دون التنازل عن التفاصيل." },
        { num: "٠٣", title: "روح وكالة إبداعية", desc: "لسنا مجرد محل طباعة. نحن مصممون يفهمون ما يجعل العلامة التجارية فعّالة." },
      ],
    },
    cta: {
    ...
    footer: {
      ...
      explore: "استكشف",
      connect: "تواصل",
      links: { ourWork: "أعمالنا", about: "عن فاست بوب", contact: "اتصل بنا", startOrder: "ابدأ طلباً" },
    ...
    about: {
      ...
      phaseLabel: "مرحلة",
      steps: [
        { step: "٠١", title: "الفكرة والإعداد", desc: "ارفع ملفاتك أو اعمل مع فريقنا. نحضّر كل شيء لدقة طباعة مثالية ومسارات قطع محكمة." },
        { step: "٠٢", title: "اختيار المواد", desc: "اختر من بين مطفي أو لامع أو هولوغرافي أو شفاف أو فينيل متين حسب احتياجاتك." },
        { step: "٠٣", title: "طباعة دقيقة", desc: "تضع آلاتنا الصناعية أحباراً غنية وزاهية تقاوم أشعة UV والخدوش." },
        { step: "٠٤", title: "توصيل سريع", desc: "نعبّئ بأمان ونشحن بسرعة حتى تبدأ في ترك أثرك فوراً." },
      ],
    },
    contact: {
      hero: "قل",
      ...
      hqAddress: "124 شارع الطباعة، الحي الإبداعي\nنيويورك، NY 10012",
    },
    portfolioPage: {
      hero: "أعمالنا",
    ...
    order: {
      ...
      step3: "٣. الملفات والجدول الزمني",
